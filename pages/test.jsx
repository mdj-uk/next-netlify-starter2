...
export default function Test(){
   return <>
      ...
      <ExportedImageFuture src="/test-lfs/karthik-sreenivas-rsx-joaKYrk-unsplash.jpg" sizes={'640px'} alt="autumn" width={4527} height={3015} style={{width: '50%', height: 'auto'}} priority useWebp={process.env.nextImageExportOptimizer_storePicturesInWEBP}/>
